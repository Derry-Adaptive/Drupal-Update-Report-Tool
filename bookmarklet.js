...
// 🔧 Helpers
    ...
    function generateUpdateReport(action = "help", filter = "all") {
        if(action==="help"){
  console.log("\n📦 Usage: generateUpdateReport(<report_type>, <filter>)");
  console.log("\nExample:");
  console.log('generateUpdateReport("csv", "all")');
  console.log('generateUpdateReport("ascii", "security")');
  console.log('generateUpdateReport("add_exclude", "views")');
  console.log("\nREPORT types:");
  console.log("  csv         - Export as CSV file");
  console.log("  ascii       - Show ASCII table");
  console.log("  commit      - Generate commit message");
  console.log("  composer    - Generate composer command");
  console.log("  all         - Run all report types");
  console.log("\nFILTER types:");
  console.log("  all         - Show all updates (default)");
  console.log("  security    - Only security updates");
  console.log("  unsupported - Only unsupported modules");
  console.log("\nModule Management:");
  console.log("  add_exclude     - Exclude module from reports");
  console.log("  remove_exclude  - Remove module from exclusions");
  console.log("  exclude_list    - Show excluded modules");
  return;
}
